...
$(document).ready(function() {
	...
	function add_data(map_data, business_data, projection) {
		...
		g.selectAll("circle")
			...
			.each(function (business_data, i) { $(this).click(
				function(circle_data) {get_reviews(business_data, circle_data, source);})
			});

			// To do: make function for drawing buttons and function to update current button text colors/weights
	...
	function get_reviews(business_data, circle_data, source) {
